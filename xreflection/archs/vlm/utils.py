...
DEFAULT_VLM_PROMPT = (
    "<image>\n"
    "Focus on the scene behind the window glass. "
    "Describe only the background details clearly, ignoring any ghosting or artifacts on the surface."
)
